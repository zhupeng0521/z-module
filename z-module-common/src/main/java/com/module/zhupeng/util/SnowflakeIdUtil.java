...
public final class SnowflakeIdUtil {
    ...
    private static final long OFFSET = LocalDate.of(2000, 1, 1).
    ...
    private static long getServerIdAsLong() {
        try {
            ...
            if (matcher.matches()) {
                ...
                if (n >= 0 && n < 8) {
                    logger.info(String.format("detect server id from host name %s: %d.", hostname, n));
                    return n;
                }
            }
