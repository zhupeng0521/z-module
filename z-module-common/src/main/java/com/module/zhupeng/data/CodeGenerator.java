...
import static com.module.zhupeng.data.ProjectConstant.*;
...
public class CodeGenerator {
    ...
    private static final String TEMPLATE_FILE_PATH = PROJECT_PATH + "/z-module-common/src/main/resources/template";
    private static final String JAVA_PATH = "/z-module-common/src/main/java";
    private static final String RESOURCES_PATH = "/z-module-common/src/main/resources";
     ...
     * date
     */
    private static final String AUTHOR = "祝大朋";
