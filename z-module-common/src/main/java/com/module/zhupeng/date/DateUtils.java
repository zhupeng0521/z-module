...
import com.module.zhupeng.util.constant.RegexType;
...
public class DateUtils {
    ...
    public static String formatToString(final Date date, DateFormatStyle dateFormatStyle) {
     ...
     * @return
     */
    public static String formatToString(final Date date, final String dateStyle) {
        DateFormat format = new SimpleDateFormat(dateStyle);
        return format.format(date);
    }

    /**
     * {@link #formatToString(Date, String)}
     * 默认格式格式 : {@link DateFormatStyle#BAR_END_SECOND}
     */
    public static String formatToString(final Date date) {
     ...
     * @return
     */
    public static Date formatToDate(final String date, final String dateStyle) {
        DateFormat format = new SimpleDateFormat(dateStyle);
        try {
    ...
    public static Date formatToDate(final String date, final DateFormatStyle dateFormatStyle) {
        return formatToDate(date, dateFormatStyle.getValue());
    }
    ...
    /**
     * 得到当前时间,字符串形式,默认格式:{@link DateFormatStyle#STRING_END_MS}
     */
    ...
    public static String currentTimeString(String dateStyle) {
        return formatToString(Calendar.getInstance().getTime(), dateStyle);
    }
